 ...
 */
final class Version20230805165805 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE post_likes (post_id INT NOT NULL, likes_id INT NOT NULL, INDEX IDX_DED1C2922F23775F (likes_id), INDEX IDX_DED1C2924B89032C (post_id), PRIMARY KEY(post_id, likes_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        $this->addSql('ALTER TABLE post_likes ADD CONSTRAINT FK_DED1C2922F23775F FOREIGN KEY (likes_id) REFERENCES likes (id) ON UPDATE NO ACTION ON DELETE CASCADE');
        $this->addSql('ALTER TABLE post_likes ADD CONSTRAINT FK_DED1C2924B89032C FOREIGN KEY (post_id) REFERENCES post (id) ON UPDATE NO ACTION ON DELETE CASCADE');
