...
* @implements PasswordUpgraderInterface<UserInstagram>
 *
 ...
 */
class UserInstagramRepository extends ServiceEntityRepository implements PasswordUpgraderInterface
{
    ...
    {
        if (!$user instanceof UserInstagram) {
...
//    /**
//     * @return UserInstagram[] Returns an array of UserInstagram objects
//     */
...
//    public function findOneBySomeField($value): ?UserInstagram
//    {
//        return $this->createQueryBuilder('u')
//            ->andWhere('u.exampleField = :val')
//            ->setParameter('val', $value)
